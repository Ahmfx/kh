...
def usernames():
    k = ''.join(choice("xczvnoiurewas") for i in range(1))
    n = ''.join(choice("xczvnoiurewas") for i in range(1))
    c = ''.join(choice("xczvnoiurewas") for i in range(1))
    z = ''.join(choice("xczvnoiurewas789") for i in range(1))
    e = ''.join(choice("xczvnoiurewas") for i in range(1))
    u1 = k + c + e + e + e
    u2 = k + z + z + z + n
    u3 = k + k + k + n + c
    s = u1,u2,u3
